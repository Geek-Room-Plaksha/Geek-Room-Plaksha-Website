  ...
  return (
    <div className="dark">
      <CardContainer className="inter-var">
        <CardBody className="bg-[#131313] border-white border-solid border-[2px] relative group/card w-full sm:w-[30rem] min-w-[23rem] h-auto min-h-[32rem] rounded-xl p-4 sm:p-6 flex flex-col">
          <div className="flex-grow">
            ...
            <CardItem
              as="p"
              translateZ="60"
              className="text-neutral-300 text-sm max-w-xs sm:max-w-sm mt-2 overflow-hidden line-clamp-3 text-left"
